...
public class ObscuringItemFader : MonoBehaviour
{
    ...
    public IEnumerator FadeOutRoutine()
    {
        ...
        float distance = currentAlpha - Settings.targetAlpla;

        while(currentAlpha - Settings.targetAlpla > 0.01f)
        {
        ...
        spriteRenderer.color = new Color(1f, 1f, 1f, Settings.targetAlpla);
    }

    public IEnumerator FadeInRoutine()
    {
        float currentAlpha = spriteRenderer.color.a;
        float distance  = 1f - Settings.targetAlpla;
